...
def add_panel_header(axis: plt.Axes, title: str) -> None:
    axis.text(
        0.012,
        0.945,
        title,
...
def plot_figure(
    ...
    fig = plt.figure(figsize=(3.42, 4.35), facecolor="white")
    ...
    axes[1].set_ylabel("Joint angle (rad)", labelpad=1.2, fontsize=6.4)
    axes[3].set_ylabel("Position", labelpad=1.2, fontsize=6.4)
...
def main() -> None:
    ...
    output_stem = "figure4_modeling_accuracy_singlecol_v7"
    ...
    print("Figure 4 single-column v7 generated:")
