"""Generate a trajectory-only single-column Figure 6 for soft-platform tracking."""
...
def plot_figure(task_data: dict[str, dict[str, dict[str, pd.DataFrame]]]) -> plt.Figure:
    ...
    fig.subplots_adjust(left=0.10, right=0.985, bottom=0.175, top=0.92, wspace=0.20)
...
def main() -> None:
    ...
    output_stem = "figure6_soft_tracking_singlecol_v3"
    ...
    metrics_path = SCRIPT_DIR / "figure6_soft_tracking_metrics_singlecol_v3.json"
    metrics_path.write_text(json.dumps(metrics, ensure_ascii=False, indent=2), encoding="utf-8")

    print("Figure 6 trajectory-only v3 generated.")
