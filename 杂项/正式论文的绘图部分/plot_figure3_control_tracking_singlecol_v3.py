...
def plot_figure(task_data: dict[str, dict[str, np.ndarray]]) -> plt.Figure:
    ...
    for col in range(3):
        axes[0, col].set_title(rf"$q_{col + 1}$", pad=2.0, fontweight="normal")

    # compact row labels
    row_labels = ("Sinusoidal", "Irregular", "Disturbance")
    ...
    # shared labels
    fig.text(0.013, 0.50, "Joint angle (rad)", rotation=90, ha="center", va="center", fontsize=5.8)
    fig.text(0.57, 0.040, "Time (s)", ha="center", va="center", fontsize=5.8)
...
def main() -> None:
    ...
    output_stem = "figure5_control_tracking_singlecol_v3"
    ...
    metrics_path = SCRIPT_DIR / "figure5_control_metrics_singlecol_v3.json"
    metrics_path.write_text(json.dumps(metrics, ensure_ascii=False, indent=2), encoding="utf-8")

    print("Figure 5 single-column v3 generated.")
