...
def plot_figure(
    ...
    fig = plt.figure(figsize=(3.42, 3.85), facecolor="white")
    ...
    for idx, component in enumerate(mechanical_components):
        ...
        configure_axis(axis)
        add_panel_header(axis, PANEL_LABELS[idx], PANEL_TITLES[idx])
    ...
    fig.text(0.030, 0.52, "Joint angle (rad)", rotation=90, ha="center", va="center", fontsize=6.8)
    fig.text(0.535, 0.52, "Position", rotation=90, ha="center", va="center", fontsize=6.8)
    fig.text(0.285, 0.925, "Robotic arm", ha="center", va="bottom", fontsize=6.8, fontweight="semibold", color="#202020")
    fig.text(0.735, 0.925, "Soft platform", ha="center", va="bottom", fontsize=6.8, fontweight="semibold", color="#202020")
...
def main() -> None:
    ...
    output_stem = "figure4_modeling_accuracy_singlecol_v4"
    ...
    print("Figure 4 single-column v4 generated:")
