...
def main() -> None:
    ...
    output_stem = "figure5_control_tracking_singlecol_v6"
    ...
    metrics_path = SCRIPT_DIR / "figure5_control_metrics_singlecol_v6.json"
    metrics_path.write_text(json.dumps(metrics, ensure_ascii=False, indent=2), encoding="utf-8")

    print("Figure 5 single-column v6 generated.")
